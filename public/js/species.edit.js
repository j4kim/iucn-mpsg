...
/* WEBPACK VAR INJECTION */(function($) {var image_template = __webpack_require__(13);

$(function () {
    var options = {
        modules: {
            toolbar: [[{ 'header': [2, 3, false] }], ['bold', 'italic', 'underline', 'strike'], ['link', 'image', 'video', 'formula'], [{ 'font': [] }], [{ 'align': [] }], [{ 'color': [] }, { 'background': [] }], ['blockquote', 'code-block'], [{ 'list': 'ordered' }, { 'list': 'bullet' }], [{ 'script': 'sub' }, { 'script': 'super' }], [{ 'indent': '-1' }, { 'indent': '+1' }], ['clean']]
        },
        theme: 'snow'
    };
    ...
    $("#image-input").change(function () {
        addImageFromInput(this, "img");
    });
    $("#map-input").change(function () {
        addImageFromInput(this, "map");
    });
